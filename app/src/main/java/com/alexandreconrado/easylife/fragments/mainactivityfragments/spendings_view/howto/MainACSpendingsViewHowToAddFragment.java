...
public class MainACSpendingsViewHowToAddFragment extends Fragment {

    private FragmentMainACSpendingsViewHowToAddBinding binding;
    ...
    public MainACSpendingsViewHowToAddFragment() {
        // Required empty public constructor
    }
    public MainACSpendingsViewHowToAddFragment(MainActivity parent, Boolean fromNext) {
        this.parent = parent;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentMainACSpendingsViewHowToAddBinding.inflate(inflater);

        fadeInAnimation(binding.frameLayoutParentFragMainACSpendingsViewHowToAdd);

        if(fromNext){
            fragIndicatorScaleDownAnimation(binding.cardViewFragIndicator2FragMainACSpendingsViewHowToAdd);
            colorChangeFadeOutAnimation(binding.cardViewFragIndicator2FragMainACSpendingsViewHowToAdd);
            fragIndicatorScaleUpAnimation(binding.cardViewFragIndicator1FragMainACSpendingsViewHowToAdd);
            colorChangeFadeInAnimation(binding.cardViewFragIndicator1FragMainACSpendingsViewHowToAdd);
        } else {
            fragIndicatorScaleUpAnimation(binding.cardViewFragIndicator1FragMainACSpendingsViewHowToAdd);
            colorChangeFadeInAnimation(binding.cardViewFragIndicator1FragMainACSpendingsViewHowToAdd);
        }
    ...
    private void setupPreviousButton(){
        binding.textViewPreviousFragMainACSpendingsViewHowToAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.textViewPreviousFragMainACSpendingsViewHowToAdd.setEnabled(false);
                switch (nextButtonState){
                    case "base":
                        fadeOutAnimation(binding.frameLayoutParentFragMainACSpendingsViewHowToAdd);
                        parent.changeHowToFragment("", true);
                        break;
                }
                binding.textViewPreviousFragMainACSpendingsViewHowToAdd.setEnabled(true);
            }
        });
    }
    private void setupNextButton(){
        binding.textViewNextFragMainACSpendingsViewHowToAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.textViewNextFragMainACSpendingsViewHowToAdd.setEnabled(false);
                switch (nextButtonState){
                    case "base":
                        stopAnims = true;
                        fadeOutEveryTimeAnimation(binding.frameLayoutParentFragMainACSpendingsViewHowToAdd);
                        parent.changeHowToFragment("Spendings_HowTo_goToDetails", false);
                        break;
                }
                binding.textViewNextFragMainACSpendingsViewHowToAdd.setEnabled(true);
            }
        });
    }
    private void longPressAnimation(){
        if(!stopAnims){
            fadeInAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd);
            fadeInAnimation(binding.cardViewTopNavigationExampleFragMainACSpendingsViewHowToAdd);
            float originalDimension = getResources().getDimension(com.intuit.sdp.R.dimen._112sdp);
            forwardAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd, (-originalDimension), 0);
            ...
            colorChangePointingAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd, initialColor, finalColor);
            new CountDownTimer(1300, 1000) {
                ...
                public void onFinish() {
                    alphaAnimation(binding.imageViewExampleButtonAddFragMainACSpendingsViewHowToAdd, 0.6f, 1.0f);
                    pointYAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd, getResources().getDimension(com.intuit.sdp.R.dimen._minus40sdp));
                    new CountDownTimer(1000, 1000) {
                        ...
                        public void onFinish() {
                            binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd.setImageDrawable(getResources().getDrawable(R.drawable.hand_tapping));
                            ...
                            new CountDownTimer(400, 1000) {
                                ...
                                public void onFinish() {
                                    binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd.setImageDrawable(getResources().getDrawable(R.drawable.hand_pointing));
                                    ...
                                    new CountDownTimer(1000, 1000) {
                                        ...
                                        public void onFinish() {
                                            fadeOutAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd);
                                            fadeOutAnimation(binding.cardViewTopNavigationExampleFragMainACSpendingsViewHowToAdd);
                                            ...
                                            new CountDownTimer(700, 1000) {
                                                ...
                                                public void onFinish() {
                                                    pointYAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd, 0);
                                                    pointBackToStartPosAnimation(binding.imageViewPointingToImageViewFragMainACSpendingsViewHowToAdd, 0, 0);
                                                    binding.imageViewExampleButtonAddFragMainACSpendingsViewHowToAdd.setAlpha(1.0f);
                                                    longPressAnimation();
                                                }
                                            }.start();
                                        }
